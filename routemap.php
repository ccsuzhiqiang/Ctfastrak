...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <title>eCtfast Route Maps</title>
    <style>
    ...
    <script>
	 ...
	 //101
		...
		var infowindow = new google.maps.InfoWindow({
             content: "101Hartford/New Britain"});
             infowindow.setPosition( {lat: 41.765179, lng: -72.673431},);
			 infowindow.open(map);
	//102
	    var stops102 = [
...
{lat:41.765179 ,  lng:-72.673431}, 
		...
		var infowindow = new google.maps.InfoWindow({
             content: "102 Hartford/New Britain/Bristol"});
             infowindow.setPosition({lat:41.671078 ,  lng:-72.943062},	);
			 infowindow.open(map);
...
{lat:41.761139,   lng:-72.563423}, 
		...
		var infowindow = new google.maps.InfoWindow({
             content: "121 MCC/Hartford/UConn Health"});
	...
	var stops128 = [ 	
		...
		var infowindow = new google.maps.InfoWindow({
             content: "128 Hartford/Westfarms-New Britain via Stanley Street"});
             infowindow.setPosition(  {lat:41.671993, lng:	-72.775352}  );
             infowindow.open(map);	
...
{lat:41.695045,   lng:-72.764771}, 
{lat:41.698414,   lng:-72.760033}, 
{lat:41.702011,   lng:-72.754013}, 
{lat:41.703583,   lng:-72.752502}, 
{lat:41.707092,   lng:-72.749458}, 
{lat:41.709568,   lng:-72.747360}, 
{lat:41.714123,   lng:-72.743568}, 
{lat:41.715828,   lng:-72.741798}, 
{lat:41.716209,   lng:-72.738129}, 
{lat:41.716595,   lng:-72.736519}, 
{lat:41.696148,   lng:-72.753922}, 
]
var route140f = new google.maps.Polyline({
          path:stops140f,
          geodesic: true,
          strokeColor: '#0000FF',
          strokeOpacity: 1.0,
        ...
        route140f.setMap(map);
		
		var infowindow = new google.maps.InfoWindow({
             content: "140(F) CCSU Shuttle"});
             infowindow.setPosition( {lat:41.714123,   lng:-72.743568}, );
             infowindow.open(map);	
...
{lat:41.724922,   lng:-72.761452},   
		...
		var infowindow = new google.maps.InfoWindow({
             content: "144 Wethersfield/Westfarms via Newington Center and Brittany Farms"});
...
{lat:41.816853,   lng:-72.713097}, 
		...
		var infowindow = new google.maps.InfoWindow({
             content: "153 Flatbush/Copaco via West Hartford Center"});
             infowindow.setPosition( {lat:41.817387,   lng:-72.719429},  );
             infowindow.open(map);

	     //161
        var stops161 = [ 
 {lat:41.770306,   lng:-72.693756},
...
{lat:41.775707,   lng:-72.698395}, 
{lat:41.775383,   lng:-72.697014},
{lat:41.775196,   lng:-72.696083}, 
{lat:41.774738,   lng:-72.694099}, 
{lat:41.773281,   lng:-72.692879}, 
{lat:41.772182,   lng:-72.693207}, 
{lat:41.770306,   lng:-72.693756}, 
{lat:41.766747,   lng:-72.693871}, 
{lat:41.764435,   lng:-72.695137}, 
{lat:41.763386,   lng:-72.692520}, 
{lat:41.763622,   lng:-72.686943}, 
{lat:41.762882,   lng:-72.683037}, 
{lat:41.760845,   lng:-72.682106}, 
{lat:41.759201,   lng:-72.682281}, 
{lat:41.757725,   lng:-72.682442}, 
{lat:41.755329,   lng:-72.680847}, 
{lat:41.755325,   lng:-72.678741}, 
{lat:41.755318,   lng:-72.677238}, 
{lat:41.753727,   lng:-72.678490}, 
{lat:41.752022,   lng:-72.681229}, 
{lat:41.753597,   lng:-72.682678}, 
 {lat:41.754742,   lng:-72.682533},
		...
		var infowindow = new google.maps.InfoWindow({
             content: "161 St. Francis Hospital/Hartford Hospital via Capitol Avenue"});
